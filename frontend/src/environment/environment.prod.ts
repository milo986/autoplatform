export const environment = {
  production: true,
  apiUrl: 'http://172.16.15.32:8181/strauss/api/chatadvisers/',
  wsUrl: 'http://chatbot.strauss.ai:8181',
  URL_IMG_Users: 'https://chatbot.strauss.ai/uploads/users',
  URL_IMG_Empresas: 'https://chatbot.strauss.ai/uploads/empresas',
  URL_IMG_BOTS: 'https://chatbot.strauss.ai/uploads/imgsBots',
  dataImgDef: 'https://chatbot.strauss.ai/templateGer/chatAdv/assets/media/svg/files/blank-image.svg',
  featureFlag: true,
