...
export class CustomizerService {
    ...
    constructor() {
        if (this.isBrowser()) {
            ...
            // Define valores por defecto para cuando localStorage no esté disponible (ej. SSR o tests)
            this.isDarkTheme = false;
            this.isSidebarDarkTheme = false;
            this.isRightSidebarTheme = false;
            this.isHideSidebarTheme = false;
            this.isHeaderDarkTheme = false;
            this.isCardBorderedTheme = false;
            this.isCardWithoutBorderRadiusTheme = false;
            this.isCardWithBoxShadowTheme = false;
